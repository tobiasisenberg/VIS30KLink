...
In addition to beinfg available from the IEEE DataPort, the data is also available through a direct download link from [https://www.cse.osu.edu/~chen.8028/VIS30K/VIS30K.tar.gz](https://www.cse.osu.edu/~chen.8028/VIS30K/VIS30K.tar.gz).
